  ...
  return (
    <div className="page-container space-y-5">
      ...
      >
        ...
        <button 
          type="button" 
          className="btn-jury-cta w-full sm:w-auto shrink-0 justify-center" 
      ...
      <div className="card p-2 bg-white border-2 border-orange-100 flex items-center gap-2 overflow-x-auto shadow-2xs scrollbar-none">
        {studioTabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={`px-3.5 py-2 rounded-xl font-extrabold text-[11px] sm:text-xs transition-all duration-200 cursor-pointer flex items-center gap-2 whitespace-nowrap shrink-0 ${
                isActive 
